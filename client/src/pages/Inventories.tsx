    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="text-sm font-medium text-blue-700">Inventory locations</p>
            <h2 className="mt-2 text-2xl font-semibold tracking-tight text-stone-950">Inventories</h2>
          </div>
        </div>
